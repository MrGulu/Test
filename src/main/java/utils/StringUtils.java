...
public class StringUtils
{
  ...
  public static Double string2double(String v)
  {
    ...
    try
    {
      return new Double(v); } catch (Exception e) {
    }
    return null;
  }
  ...
  public static int string2Int(String v, int defaultV)
  {
    ...
    try
    {
      return new Integer(v).intValue(); } catch (Exception e) {
    }
    return defaultV;
  }
  ...
  public static long string2Long(String v, long defaultV)
  {
    ...
    try
    {
      return new Long(v).longValue(); } catch (Exception e) {
    }
    return defaultV;
  }
...
public static boolean isEmpty(String str) {
  ...
  public static String r2c(String n0)
  {
    ...
    for (int i = 1; i <= L; i += 1) {
      ...
      if (((i > 7 ? 1 : 0) & (i < 11 ? 1 : 0)) == 0) { if (((i > 15 ? 1 : 0) & (i < 19 ? 1 : 0)) == 0);
      } else b = n == 0 & b;
